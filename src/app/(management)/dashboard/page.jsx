...
function dashboard() {
  ...
  <div className="flex justify-between">
    <div className='lg:w-1/4 w-1/3'>
      ...
      <Image src="/ProfilePic.jpg" alt="dashboard" height={500} width={450} className="flexCenter gap-2 mt-2 rounded-[8px] flex-col"/>
    ...
    <div className='lg:w-3/4 w-2/3'>
      ...
      <Button title='Download' type='submit' variant='btn_dark_blue_shadow' href='' />     
      </div>
    </div>
  </div>
  )
