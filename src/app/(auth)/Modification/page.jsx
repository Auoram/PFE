    ...
    <div className="flex flex-col items-center justify-center h-100vh py-20">
      <div className="border rounded-md shadow-xl lg:w-2/3 w-2/3 items-center justify-center flex flex-col py-10">
        <div className="text-center mb-8">
          <h1 className="text-blue-60 regular-30 mb-1">Modification</h1>
        ...
        <div className="flex flex-col mb-2">
          ...
          <div className="pb-2 w-72">
            <input type="email" name="email" placeholder="Your email" className="border border-blue-60 w-full py-2 px-3 focus:outline-none focus:border-green-60"/>
          </div>
        </div>
        <div className="flex flex-col mb-2">
        ...
        <Button type="submit" title="Modify" variant="btn_dark_green_shadow" href="/settings">
