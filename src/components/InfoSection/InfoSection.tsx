...
function InfoSection() {
  return (
    <div className="text-center mx-auto my-5 max-w-2xl px-4 sm:py-auto lg:max-w-7xl lg:px-8 pb-32 lg:py-16">
        <h1 className=" text-blue-30 regular-32 mt-5 mb-20">Why <span className="text-blue-45">Vaccinate</span> our children ?</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
  <div className="flex flex-col items-center">
    <Image src="/baby_3.jpg" alt="Image 1" className="w-full mb-4" height={263} width={296} />
    <h1 className="regular-24 mb-2 text-blue-30">Disease Prevention</h1>
  ...
  <div className="flex flex-col items-center">
    <Image src="/cost3.jpg" alt="Image 2" className="w-full mb-4" height={263} width={296} />
    <h1 className="regular-24 mb-2 text-blue-30">Reduced Healthcare Costs</h1>
  ...
  <div className="flex flex-col items-center">
    ...
    <h1 className="regular-24 mb-2 text-blue-30">School Attendance</h1>
